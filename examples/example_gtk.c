...
//    gtk_window_present(GTK_WINDOW(window)); // I think this should bring the window to the foreground, but it might be broken on mac, or maybe it dosen't work when the application is compiled without a plist.
